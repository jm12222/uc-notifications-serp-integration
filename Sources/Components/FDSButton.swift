            ...
            ScrollView {
                VStack(spacing: 12) {
                    ...
                    ButtonGroupCard(title: "Menu button") {
                        VStack(spacing: 12) {
                            FDSButton(type: .secondary, label: "Select option", size: .large, widthMode: .constrained, isMenuButton: true, action: {})
                            FDSButton(type: .secondary, label: "Select option", size: .medium, widthMode: .constrained, isMenuButton: true, action: {})
                            FDSButton(type: .secondary, label: "Select option", size: .small, widthMode: .constrained, isMenuButton: true, action: {})
                        }
                    }
                }
                .padding()
